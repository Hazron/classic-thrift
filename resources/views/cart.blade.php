                    ...
                    <div class="mobile-header-left">
                        <ul class="mobile-menu-logo">
                            <li>
                                <a href="/">
                                    <div class="logo">
                                        <img src="images/logo/ClassicThrift.png" alt="">
                                    </div>
                                </a>
                            </li>
                        </ul>
    ...
    <div id="offcanvas-add-cart" class="offcanvas offcanvas-rightside offcanvas-add-cart-section">
        ...
        <div class="offcanvas-add-cart-wrapper">
            ...
            <div class="offcanvas-cart-total-price">
                ...
                <span class="offcanvas-cart-total-price-value">Rp. 5.000</span>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product_thumb"><a href="/product-details-default"><img
                                                        src="images/product/default/home-1/kemeja1.jpeg"
                                                        alt=""></a></td>
                                            <td class="product_name"><a href="/product-details-default">Cheap T-Shirts</a></td>
                                            <td class="product-price">Rp. 5</td>
                                            
                                            <td class="product_total">Rp. 5</td>
                        ...
                        <div class="coupon_code right" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="coupon_inner">
                                <div class="cart_subtotal">
                                    <p>Subtotal</p>
                                    <p class="cart_amount">Rp. 5.000</p>
                                </div>
                                <div class="cart_subtotal ">
                                    <p>Shipping</p>
                                ...
                                <div class="cart_subtotal">
                                    <p>Total</p>
                                    <p class="cart_amount">Rp. 7.000</p>
                                </div>
                                <div class="checkout_btn">
                                    <a href="#" class="btn btn-md btn-golden">Prosceed to Checkout</a>
                                </div>
                            </div>
                        </div>
                    </div>
